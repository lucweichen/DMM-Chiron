...
-- Name: cactivity_wkfid_fk; Type: FK CONSTRAINT; Schema: public; Owner: chiron
--
...
-- Name: cfield_realid_fk; Type: FK CONSTRAINT; Schema: public; Owner: chiron
--
...
-- Name: coperand_actid_fk; Type: FK CONSTRAINT; Schema: public; Owner: chiron
--
...
-- Name: crelation_actid_fk; Type: FK CONSTRAINT; Schema: public; Owner: chiron
--
...
-- Name: dependency_cactid_fk; Type: FK CONSTRAINT; Schema: public; Owner: chiron
--
...
-- Name: eactibity_cactid_fk; Type: FK CONSTRAINT; Schema: public; Owner: chiron
--
...
-- Name: eactivity_wkfid_fk; Type: FK CONSTRAINT; Schema: public; Owner: chiron
--

ALTER TABLE ONLY eactivity
    ADD CONSTRAINT eactivity_wkfid_fk FOREIGN KEY (wkfid) REFERENCES eworkflow(ewkfid);


--
-- TOC entry 2244 (class 2606 OID 80125)
-- Dependencies: 2222 171 172
-- Name: efile_actid_fk; Type: FK CONSTRAINT; Schema: public; Owner: chiron
--
...
-- Name: efile_taskid_fk; Type: FK CONSTRAINT; Schema: public; Owner: chiron
--
...
-- Name: ekeyspace_fk; Type: FK CONSTRAINT; Schema: public; Owner: chiron
--
...
-- Name: etask_actid_fk; Type: FK CONSTRAINT; Schema: public; Owner: chiron
--
...
-- Name: eworkflow_fk; Type: FK CONSTRAINT; Schema: public; Owner: chiron
--
...
--
-- TOC entry 2248 (class 2606 OID 80150)
-- Dependencies: 2232 175 174
-- Name: machineid_fk; Type: FK CONSTRAINT; Schema: public; Owner: chiron
--

ALTER TABLE ONLY eworkflow
    ADD CONSTRAINT machineid_fk FOREIGN KEY (machineid) REFERENCES emachine(machineid);
