grant usage, select on sequence wkFid_seq,actid_seq,relid_seq,taskid_seq to liu;
GRANT ALL PRIVILEGES ON test TO liu;
--
...
-- Dependencies: 563 6
-- Name: f_activation(integer, integer, integer, integer, character varying, character varying, text, text, timestamp with time zone, timestamp with time zone, character varying, text, character, text); Type: FUNCTION; Schema: public; Owner: chiron
--

CREATE FUNCTION f_activation(v_taskid integer, v_actid integer, v_processor integer, v_exitstatus integer, v_commandline character varying, v_workspace character varying, v_terr text, v_tout text, v_starttime timestamp with time zone, v_endtime timestamp with time zone, v_status character varying, v_extractor text, v_constrained character, v_templatedir text, v_machine integer, v_site integer) RETURNS integer
    LANGUAGE plpgsql
    AS $$
...
select nextval('taskid_seq') into d_taskid;
        insert into eactivation(taskid, actid, processor, exitstatus, commandline, workspace, terr, tout, starttime, endtime, status, extractor, constrained, templatedir, machine, site) values(d_taskid, v_actid, v_processor, v_exitstatus, v_commandline, v_workspace, v_terr, v_tout, v_starttime, v_endtime, v_status, v_extractor, v_constrained, v_templatedir, v_machine, v_site);
else
    update eactivation set actid = v_actid, processor = v_processor, exitstatus = v_exitstatus, commandline = v_commandline, workspace = v_workspace, terr = v_terr, tout = v_tout, starttime = v_starttime, endtime = v_endtime, status = v_status, extractor = v_extractor, templatedir = v_templatedir, machine = v_machine, site = v_site where taskid = d_taskid;
end if;
 return d_taskid;
end;
$$;
...
-- TOC entry 194 (class 1255 OID 79961)
-- Dependencies: 563 6
-- Name: f_activationlocal(integer, integer, integer, integer, character varying, character varying, text, text, timestamp with time zone, timestamp with time zone, character varying, text, character, text); Type: FUNCTION; Schema: public; Owner: chiron
--

CREATE FUNCTION f_activationlocal(v_taskid integer, v_actid integer, v_processor integer, v_exitstatus integer, v_commandline character varying, v_workspace character varying, v_terr text, v_tout text, v_starttime timestamp with time zone, v_endtime timestamp with time zone, v_status character varying, v_extractor text, v_constrained character, v_templatedir text, v_machine integer, v_site integer) RETURNS integer
    LANGUAGE plpgsql
    AS $$
declare d_taskid integer;
begin
insert into eactivation(taskid, actid, processor, exitstatus, commandline, workspace, terr, tout, starttime, endtime, status, extractor, constrained, templatedir, machine, site) values(v_taskid, v_actid, v_processor, v_exitstatus, v_commandline, v_workspace, v_terr, v_tout, v_starttime, v_endtime, v_status, v_extractor, v_constrained, v_templatedir, v_machine, v_site);
 return d_taskid;
end;
$$;
...
-- Dependencies: 6 563
-- Name: f_activity(integer, integer, character varying, character varying, timestamp with time zone, timestamp with time zone, integer); Type: FUNCTION; Schema: public; Owner: chiron
--
...
-- Dependencies: 6 563
-- Name: f_cactivity(integer, integer, character varying, character varying, character varying, character varying, character varying, text); Type: FUNCTION; Schema: public; Owner: chiron
--

CREATE FUNCTION f_cactivity(v_actid integer, v_wkfid integer, v_tag character varying, v_atype character varying, v_description character varying, v_activation character varying, v_extractor character varying, v_templatedir text, v_workload double precision) RETURNS integer
    LANGUAGE plpgsql
    AS $$
declare d_actid integer;
begin
 ...
 if (coalesce(d_actid, 0) = 0) then
   select nextval('actid_seq') into d_actid;
   insert into cactivity(actid, wkfid, tag, atype, description, activation, extractor, templatedir, workload) values(d_actid, v_wkfid, v_tag, v_atype, v_description, v_activation, v_extractor, v_templatedir, v_workload);
 else 
   update cactivity set atype = v_atype, description = v_description, templatedir = v_templatedir, activation = v_activation, extractor = v_extractor, workload = v_workload where actid = d_actid;
 end if;
 return d_actid;
end;
$$;
...
-- Dependencies: 563 6
-- Name: f_crelation(integer, character varying, character varying, integer); Type: FUNCTION; Schema: public; Owner: chiron
--
...
-- Dependencies: 563 6
-- Name: f_cworkflow(integer, character varying, character varying); Type: FUNCTION; Schema: public; Owner: chiron
--
...
-- Dependencies: 563 6
-- Name: f_del_workflow(character varying); Type: FUNCTION; Schema: public; Owner: chiron
--
...
-- Dependencies: 6 563
-- Name: f_del_workflows(character varying); Type: FUNCTION; Schema: public; Owner: chiron
--
...
CREATE FUNCTION f_del_workflows(v_tag character varying) RETURNS integer
    ...
    AS $$
begin
	delete from eovalue where exists (
		select * from hactivity a, eworkflow w where a.actid = eovalue.actid and a.wkfid = w.wkfid and w.tag = v_tag
	);
	
	delete from evalue where exists (
		select * from hactivity a, eworkflow w	where a.actid = evalue.actid and a.wkfid = w.wkfid	and w.tag = v_tag
	);
...
-- Dependencies: 6 563
-- Name: f_ekeyspace(integer, integer, character varying, integer, integer, character varying); Type: FUNCTION; Schema: public; Owner: chiron
--
...
insert into efile(fileid, actid, taskid, fdir, fname, fsize, fdata, ftemplate, finstrumented, foper, fieldname, fsite) values(d_fileid, v_actid, v_taskid, v_fdir, v_fname, v_fsize, v_fdata, v_ftemplate, v_finstrumented, v_foper, v_fieldname, v_fsite);
else 
update efile set ftemplate = v_ftemplate, finstrumented = v_finstrumented, fdir = v_fdir, fname = v_fname, fsize = v_fsize, fdata = v_fdata, fsite = v_fsite where d_fileid = fileid;
end if;
return d_fileid;
end;
$$;
...
-- TOC entry 202 (class 1255 OID 79969)
-- Dependencies: 6 563
-- Name: f_filelocal(integer, integer, integer, character varying, character varying, character varying, character varying, integer, timestamp with time zone, character varying, character varying); Type: FUNCTION; Schema: public; Owner: chiron
--

CREATE FUNCTION f_filelocal(v_fileid integer, v_actid integer, v_taskid integer, v_ftemplate character varying, v_finstrumented character varying, v_fdir character varying, v_fname character varying, v_fsize integer, v_fdata timestamp with time zone, v_foper character varying, v_fieldname character varying, v_fsite integer) RETURNS integer
    LANGUAGE plpgsql
    AS $$
declare d_fileid integer;
begin
insert into efile(fileid, actid, taskid, fdir, fname, fsize, fdata, ftemplate, finstrumented, foper, fieldname, fsite) values(v_fileid, v_actid, v_taskid, v_fdir, v_fname, v_fsize, v_fdata, v_ftemplate, v_finstrumented, v_foper, v_fieldname, v_fsite);
return d_fileid;
end;
$$;


ALTER FUNCTION public.f_file(v_fileid integer, v_actid integer, v_taskid integer, v_ftemplate character varying, v_finstrumented character varying, v_fdir character varying, v_fname character varying, v_fsize integer, v_fdata timestamp with time zone, v_foper character varying, v_fieldname character varying, v_fsite character varying) OWNER TO chiron;

--
-- TOC entry 203 (class 1255 OID 79970)
-- Dependencies: 6 563
-- Name: f_relation(integer, integer, character varying, character varying, character varying, character varying); Type: FUNCTION; Schema: public; Owner: chiron
--
...
-- Dependencies: 563 6
-- Name: f_workflow(integer, character varying, character varying, character varying, character varying); Type: FUNCTION; Schema: public; Owner: chiron
--

CREATE FUNCTION f_workflow(v_wkfid integer, v_tag character varying, v_tagexec character varying, v_expdir character varying, v_wfdir character varying) RETURNS integer
    LANGUAGE plpgsql
    AS $$
declare d_wkfid integer;
begin
 ...
 if (coalesce(d_wkfid, 0) = 0) then
   select nextval('wkfid_seq') into d_wkfid;
   insert into eworkflow(ewkfid, tag, tagexec, expdir, wfdir) values(d_wkfid, v_tag, v_tagexec, v_expdir, v_wfdir);
 end if;
 return d_wkfid;
end;
$$;
...
ALTER FUNCTION public.f_workflow(v_wkfid integer, v_tag character varying, v_tagexec character varying, v_expdir character varying, v_wfdir character varying) OWNER TO chiron;

--
-- TOC entry 161 (class 1259 OID 79972)
-- Dependencies: 6
-- Name: actid_seq; Type: SEQUENCE; Schema: public; Owner: chiron
--
...
-- Dependencies: 6
-- Name: cactid_seq; Type: SEQUENCE; Schema: public; Owner: chiron
--
...
-- Dependencies: 2189 6
-- Name: cactivity; Type: TABLE; Schema: public; Owner: chiron; Tablespace: 
--
...
-- Dependencies: 6
-- Name: cfield; Type: TABLE; Schema: public; Owner: chiron; Tablespace: 
--
...
-- Dependencies: 2190 6
-- Name: coperand; Type: TABLE; Schema: public; Owner: chiron; Tablespace: 
--
...
-- Dependencies: 6
-- Name: copid_seq; Type: SEQUENCE; Schema: public; Owner: chiron
--
...
-- Dependencies: 2191 6
-- Name: crelation; Type: TABLE; Schema: public; Owner: chiron; Tablespace: 
--
...
-- Dependencies: 6
-- Name: cwkfid_seq; Type: SEQUENCE; Schema: public; Owner: chiron
--
...
-- Dependencies: 2192 6
-- Name: cworkflow; Type: TABLE; Schema: public; Owner: chiron; Tablespace: 
--
...
-- Dependencies: 2193 6
-- Name: eactivation; Type: TABLE; Schema: public; Owner: chiron; Tablespace: 
--
...
-- Dependencies: 2194 6
-- Name: eactivity; Type: TABLE; Schema: public; Owner: chiron; Tablespace: 
--
...
-- Name: efile; Type: TABLE; Schema: public; Owner: chiron; Tablespace: 
--
...
-- TOC entry 172 (class 1259 OID 80016)
-- Dependencies: 2195 2196 2197 6
-- Name: ifsite; Type: TABLE; Schema: public; Owner: chiron; Tablespace: 
--

CREATE TABLE ifsite (
    ifsid integer DEFAULT nextval(('fileid_seq'::text)::regclass) NOT NULL,
    fdir character varying(500),
    fname character varying(500),
    fsize bigint,
    fsite integer
...
ALTER TABLE public.ifsite OWNER TO chiron;
...
CREATE TABLE site(
    ...
    publicip character varying(500),
    cpunumber integer,
    provbw double precision
);


ALTER TABLE public.site OWNER TO chiron;
...
CREATE TABLE connection(
    ...
    tsiteid integer,
    tport integer,
    databw double precision
);


ALTER TABLE public.connection OWNER TO chiron;
...
CREATE TABLE vm(
    ...
    siteid integer,
    mpiid integer,
    privateip character varying(500),
    cpunumber integer,
    type character varying(500),
    comcap double precision,
    price double precision
);


ALTER TABLE public.vm OWNER TO chiron;
...
-- Dependencies: 6
-- Name: ekeyspace; Type: TABLE; Schema: public; Owner: chiron; Tablespace: 
--
...
-- Dependencies: 2198 6
-- Name: emachine; Type: TABLE; Schema: public; Owner: chiron; Tablespace: 
--
...
CREATE TABLE emachine (
    ...
    userpwd character varying(30) NOT NULL
);
...
-- Dependencies: 2199 6
-- Name: eworkflow; Type: TABLE; Schema: public; Owner: chiron; Tablespace: 
--
...
-- Dependencies: 6
-- Name: fieldid_seq; Type: SEQUENCE; Schema: public; Owner: chiron
--
...
-- Dependencies: 6
-- Name: fileid_seq; Type: SEQUENCE; Schema: public; Owner: chiron
--
...
-- Dependencies: 6
-- Name: machineid_seq; Type: SEQUENCE; Schema: public; Owner: chiron
--
...
-- Dependencies: 6
-- Name: relid_seq; Type: SEQUENCE; Schema: public; Owner: chiron
--
...
-- Dependencies: 6
-- Name: taskid_seq; Type: SEQUENCE; Schema: public; Owner: chiron
--
...
-- Dependencies: 6
-- Name: wkfid_seq; Type: SEQUENCE; Schema: public; Owner: chiron
--
...
-- Name: cactivity_pkey; Type: CONSTRAINT; Schema: public; Owner: chiron; Tablespace: 
--
...
-- Name: cfield_pk; Type: CONSTRAINT; Schema: public; Owner: chiron; Tablespace: 
--
...
-- Name: coperand_pk; Type: CONSTRAINT; Schema: public; Owner: chiron; Tablespace: 
--
...
-- Name: crelation_pk; Type: CONSTRAINT; Schema: public; Owner: chiron; Tablespace: 
--
...
-- Name: cworkflow_pk; Type: CONSTRAINT; Schema: public; Owner: chiron; Tablespace: 
--
...
-- Name: eactivity_pkey; Type: CONSTRAINT; Schema: public; Owner: chiron; Tablespace: 
--
...
-- Name: efile_pk; Type: CONSTRAINT; Schema: public; Owner: chiron; Tablespace: 
--
...
ALTER TABLE ONLY ifsite
    ADD CONSTRAINT ifsite_pk PRIMARY KEY (ifsid);

ALTER TABLE efile CLUSTER ON ifsite_pk;
...
-- Name: ekeyspace_pk; Type: CONSTRAINT; Schema: public; Owner: chiron; Tablespace: 
--
...
-- Name: emachineid_pk; Type: CONSTRAINT; Schema: public; Owner: chiron; Tablespace: 
--
...
-- Name: etask_pk; Type: CONSTRAINT; Schema: public; Owner: chiron; Tablespace: 
--
...
-- Name: eworkflow_pk; Type: CONSTRAINT; Schema: public; Owner: chiron; Tablespace: 
--
...
-- Dependencies: 163
-- Name: c_activity_wkfid; Type: INDEX; Schema: public; Owner: chiron; Tablespace: 
--
...
-- Name: c_field_key; Type: INDEX; Schema: public; Owner: chiron; Tablespace: 
--
...
-- Dependencies: 163
-- Name: cactivity_actid; Type: INDEX; Schema: public; Owner: chiron; Tablespace: 
--
...
-- Dependencies: 165
-- Name: coperand_opid; Type: INDEX; Schema: public; Owner: chiron; Tablespace: 
--
...
-- Dependencies: 167
-- Name: crelation_relid; Type: INDEX; Schema: public; Owner: chiron; Tablespace: 
--
...
-- Dependencies: 169
-- Name: cworkflow_index; Type: INDEX; Schema: public; Owner: chiron; Tablespace: 
--
...
-- Dependencies: 169
-- Name: cworkflow_index_tag; Type: INDEX; Schema: public; Owner: chiron; Tablespace: 
--
...
-- Dependencies: 170
-- Name: e_activation_actid; Type: INDEX; Schema: public; Owner: chiron; Tablespace: 
--
...
-- Dependencies: 171
-- Name: e_activity_wkfid; Type: INDEX; Schema: public; Owner: chiron; Tablespace: 
--
...
-- Dependencies: 172
-- Name: e_file_actid; Type: INDEX; Schema: public; Owner: chiron; Tablespace: 
--
...
-- Dependencies: 172
-- Name: e_file_taskid; Type: INDEX; Schema: public; Owner: chiron; Tablespace: 
--
...
-- Dependencies: 170
-- Name: eactivation_taskid; Type: INDEX; Schema: public; Owner: chiron; Tablespace: 
--
...
-- Dependencies: 171
-- Name: eactivity_actid; Type: INDEX; Schema: public; Owner: chiron; Tablespace: 
--
...
-- Dependencies: 172
-- Name: efile_fileid; Type: INDEX; Schema: public; Owner: chiron; Tablespace: 
--
...
-- Dependencies: 6
-- Name: public; Type: ACL; Schema: -; Owner: chiron
--
...
-- Dependencies: 163
-- Name: cactivity; Type: ACL; Schema: public; Owner: chiron
--
...
-- Dependencies: 164
-- Name: cfield; Type: ACL; Schema: public; Owner: chiron
--
...
-- Dependencies: 165
-- Name: coperand; Type: ACL; Schema: public; Owner: chiron
--
...
-- Dependencies: 167
-- Name: crelation; Type: ACL; Schema: public; Owner: chiron
--
...
-- Dependencies: 169
-- Name: cworkflow; Type: ACL; Schema: public; Owner: chiron
--
...
-- Dependencies: 170
-- Name: eactivation; Type: ACL; Schema: public; Owner: chiron
--
...
-- Dependencies: 171
-- Name: eactivity; Type: ACL; Schema: public; Owner: chiron
--
...
-- Dependencies: 172
-- Name: efile; Type: ACL; Schema: public; Owner: chiron
--
...
-- Dependencies: 173
-- Name: ekeyspace; Type: ACL; Schema: public; Owner: chiron
--
...
-- Dependencies: 174
-- Name: emachine; Type: ACL; Schema: public; Owner: chiron
--
...
-- Dependencies: 175
-- Name: eworkflow; Type: ACL; Schema: public; Owner: chiron
--
