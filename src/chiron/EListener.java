            ...
            try {
                ...
                if (received != null) {
                    if (received.type == EMessage.Type.FINISH) {
                        ...
                        if(received!=null&&received.activation!=null&&received.activation[0]!=null)
                            System.out.println("[EListener] got activation id: " + received.activation[0].id);
                        EMessage message = body.answerRequest(received);
                        if(received!=null&&received.activation!=null&&received.activation[0]!=null)
                            System.out.println("[EListener] got answer id: " + received.activation[0].id);
