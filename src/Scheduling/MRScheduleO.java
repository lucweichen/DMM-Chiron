 ...
 * @author luc
 */
public class MRScheduleO {
    
    public static Map<Integer, List<Integer>> MRSchedule(EActivity act, Map<Integer, List<Integer>> schedulePlan, List<EActivation> tasks, Map<Integer, EActivation> taskMap) {
        try {
            ...
            for (int id : ids) {
                ...
                schedulePlan = ScheduleTools.insertId(ScheduleTools.getDataSite(activation), id, schedulePlan);
            }
