 ...
 */
public class ActSchedule implements Scheduler {
...
//            showschedule();
            ...
            switch(Chiron.schedule){
                ...
                System.out.println("schedule begin: " + new Timestamp(date.getTime()) + " with MR algorithm");
                break;
                case "MCT":schedulePlan = MCTSchedule.mctSchedule(act, act.operation.workload, schedulePlan, sites); 
                System.out.println("schedule begin: " + new Timestamp(date.getTime()) + " with MCT algorithm");
                break;
                case "DIM":schedulePlan = DIMSchedule.DIM(act, act.operation.workload, schedulePlan, sites);
